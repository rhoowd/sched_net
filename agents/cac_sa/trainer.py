...
import six
import numpy as np
from agents.cac_sa.agent import SAPredatorAgentFO
...
class Trainer(object):
    ...
    def __init__(self, env):
        ...
        self._predator_agent = SAPredatorAgentFO(n_agent=self._agent_profile['predator']['n_agent'],
    ...
    def learn(self):
        ...
        while global_step < training_step:
            ...
            while not done:
                ...
                obs_n, reward_n, done_n, info_n = self._env.step(action_n) # obs_n_next
                ...
                self.train_agents(state, obs_n, action_n, reward_n, state_next, done_single)
    ...
    def train_agents(self, state, obs_n, action_n, reward_n, state_next, done):
        # train predator only
