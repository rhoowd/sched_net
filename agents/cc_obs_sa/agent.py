...
from agents.cc_obs_sa.replay_buffer import ReplayBuffer
from agents.cc_obs_sa.ac_network import ActorNetwork
from agents.cc_obs_sa.ac_network import CriticNetwork
...
class SAPredatorAgentObs(object):
