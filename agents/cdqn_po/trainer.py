...
class Trainer(object):
    ...
    def __init__(self, env):
        logger.info("Centralized DQN PO Trainer is created")
    ...
    def learn(self):
        ...
        while step < training_step:
            ...
            while True:
                ...
                self.train_agents(state, action, reward, state_n, done_single, obs, obs_n)
    ...
    def train_agents(self, state, action, reward, state_n, done, obs, obs_n):
        self._agent.train(state, action, reward, state_n, done, obs, obs_n)
